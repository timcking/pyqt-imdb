...
class Ui_CastDialog(object):
    def setupUi(self, CastDialog):
        ...
        self.label_3 = QtWidgets.QLabel(CastDialog)
        self.label_3.setObjectName("label_3")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_3)
        self.leName = QtWidgets.QLineEdit(CastDialog)
        ...
        CastDialog.setTabOrder(self.leName, self.leBirth)
    ...
    def retranslateUi(self, CastDialog):
        ...
        self.label_3.setText(_translate("CastDialog", "Name"))
